      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Transform your transcripts into content</p>
          </div>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-medium text-gray-500">Transcripts this month</h3>
        ...
        <div className="card">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Your Transcripts</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-gray-500">Upload your first transcript to get started.</p>
